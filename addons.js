...
module.exports = {
    ...
    helloStr : 'Меня зовут Валерий. Мы с женой Ириной - консультанты по питанию и организаторы клуба здорового образа жизни, а еще проводим марафоны стройности.  Наш результат минус 2 размера одежды и улучшение качества жизни!',
